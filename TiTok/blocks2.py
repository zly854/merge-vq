...
#Patchfy image -> (B, 256, dim)
#concat latent tokens -> (B, 257, dim)
#
class TiTokEncoder(nn.Module):
    def __init__(self, args):
        super().__init__()
        #self.config = config
        self.image_size = args.dataset.preprocessing.crop_size 
        self.patch_size = args.model.vq_model.vit_enc_patch_size
        self.grid_size = self.image_size // self.patch_size
        self.model_size = args.model.vq_model.vit_enc_model_size
        self.num_latent_tokens = args.model.vq_model.num_latent_tokens
        self.token_size = args.model.vq_model.token_size
...
class TiTokDecoder(nn.Module):
    def __init__(self, args):
        ...
        self.grid_size = self.image_size // self.patch_size
        self.model_size = args.model.vq_model.vit_dec_model_size
        self.num_latent_tokens = args.model.vq_model.num_latent_tokens
        self.token_size = args.model.vq_model.token_size
        self.width = {
                "small": 512,
